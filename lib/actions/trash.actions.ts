...
export async function deleteDocument({ collectionName, documentId, userId, schoolId, trashMessage, historyMessage, actionType }: DocumentProps) {
    try {
        ...
        const autoDelete = school?.autoDeleteTrash
