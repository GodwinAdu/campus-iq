...
import { deleteSupplier } from "@/lib/actions/inventory-supplier.actions";
  ...
  const handleDeleteSupplier = async (id: string) => {
    try {
      ...
      toast({
        ...
        description: "Please Supplier was deleted successfully...",
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          {isLoading ? (
            ...
            <>
              {role?.editClass && (
                <Link href={`/admin/${id}/inventory/suppliers/${data?._id}`}>
                  <DropdownMenuItem>
      ...
      {isDeleteDialogOpen && (
        <DeleteDialog
          ...
          onContinue={handleDeleteSupplier}
        />
      )}
    </>
  );
