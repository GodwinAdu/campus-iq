...
import { deleteStore } from "@/lib/actions/inventory-store.actions";


interface CellActionProps {
  data: IInventoryStore;
}
  ...
  const handleDeleteStore = async (id: string) => {
    try {
      ...
      toast({
        ...
        description: "Please Store was deleted successfully...",
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          {isLoading ? (
            ...
            <>
              {role?.editClass && (
                <Link href={`/admin/${id}/inventory/stores/${data?._id}`}>
                  <DropdownMenuItem>
