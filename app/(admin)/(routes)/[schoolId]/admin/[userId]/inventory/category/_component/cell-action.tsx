...
import { deleteCategory } from "@/lib/actions/inventory-category.actions";
  ...
  const handleDeleteCategory = async (id: string) => {
    try {
      ...
      toast({
        ...
        description: "Please Category was deleted successfully...",
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          {isLoading ? (
            ...
            <>
              {role?.editClass && (
                <Link href={`/admin/${id}/inventory/category/${data?._id}`}>
                  <DropdownMenuItem>
