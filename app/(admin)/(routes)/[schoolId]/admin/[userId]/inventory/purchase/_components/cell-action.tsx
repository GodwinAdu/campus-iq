...
import { deletePurchase } from "@/lib/actions/inventory-purchase.actions";


interface CellActionProps {
  data: IInventoryPurchase;
}
  ...
  const handleDeletePurchase = async (id: string) => {
    try {
      ...
      toast({
        ...
        description: "Please Purchase was deleted successfully...",
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          {isLoading ? (
            ...
            <>
              {role?.editClass && (
                <Link href={`/admin/${id}/inventory/purchase/${data?._id}`}>
                  <DropdownMenuItem>
      ...
      {isDeleteDialogOpen && (
        <DeleteDialog
          ...
          onContinue={handleDeletePurchase}
        />
      )}
    </>
  );
