  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px] w-[96%]">
        <DialogHeader>
          <DialogTitle>Create School Designation</DialogTitle>
          <DialogDescription>New School Designation .</DialogDescription>
        </DialogHeader>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Enter Designation Name</FormLabel>
                    <FormControl>
                      <Input
                        placeholder="Eg. Office, security"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
