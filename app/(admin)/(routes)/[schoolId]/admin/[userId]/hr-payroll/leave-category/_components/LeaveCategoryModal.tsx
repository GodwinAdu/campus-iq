...
import { createLeave } from "@/lib/actions/leave-category.actions";
...
export function LeaveCategoryModal() {
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px] w-[96%]">
        <DialogHeader>
          ...
          <DialogDescription>Create new Leave Category .</DialogDescription>
        </DialogHeader>
