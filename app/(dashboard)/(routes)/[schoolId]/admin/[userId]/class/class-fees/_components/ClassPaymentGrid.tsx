...
import { fetchStudentsForClassFeesList } from '@/lib/actions/student.actions';
import { columns } from './column';


const ClassPaymentGrid = ({ classes }: { classes: IClass[] }) => {
    ...
    useEffect(() => {
        const fetchStudent = async () => {
            try {
                setIsLoading(true)
                const data = await fetchStudentsForClassFeesList(selectedClass as string)
                setStudentList(data)
...
export default ClassPaymentGrid
