...
export default function ReportingSettings({ school }: { school:ISchool }) {
    const router = useRouter();
    const branchId = school._id;

    const defaultValues: Partial<ReportingSettingsValues> = school.reportSettings ? { reportSettings: { ...school.reportSettings, dataRetentionPeriod: school.reportSettings.reportSettings?.dataRetentionPeriod ?? 1 } } : {
        reportSettings: {
            enabledReports: [],
            reportTypes: [],
