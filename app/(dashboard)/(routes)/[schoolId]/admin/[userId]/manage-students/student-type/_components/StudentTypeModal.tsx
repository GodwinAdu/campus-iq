...
import { createStudentCategory } from "@/lib/actions/student-category.actions";
...
export function StudentTypeModal() {
    ...
    return (
        <Dialog>
            ...
            <DialogContent className="sm:max-w-[425px] w-[96%]">
                <DialogHeader>
                    <DialogTitle>Student Type</DialogTitle>
                    <DialogDescription>Create new Student Category .</DialogDescription>
                </DialogHeader>
